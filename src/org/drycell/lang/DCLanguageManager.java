...
public class DCLanguageManager {
	
	private FileConfiguration langFile;
	private File file;
	private DrycellPlugin plugin;
	
	public DCLanguageManager(DrycellPlugin plugin){
		this.plugin = plugin;
		this.file = new File(plugin.getDataFolder(),plugin.getDCConfig().getString("lang"));
		reloadLangFile();
		loadDefaults();
	}
